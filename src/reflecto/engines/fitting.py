...
"""
    ...
    def run(self, verbose=True):
        ...
        p_f_d.min=self.init_d*0.7
        p_f_d.max=self.init_d*1.3
        p_f_sig = pars.append("v.set_f_sig", model)
        p_f_sig.min=self.init_sigma*0.7
        p_f_sig.max=self.init_sigma*1.3
        p_f_sld = pars.append("v.set_f_sld", model)
        p_f_sld.min=self.init_sld*0.7
        p_f_sld.max=self.init_sld*0.3
        ...
        p_s_sig.value=3.0
        p_s_sig.min=p_s_sig.value * 0.7
        p_s_sig.max=p_s_sig.value * 1.3
        p_s_sld = pars.append("v.set_s_sld", model)
        p_s_sld.value=18.8
        p_s_sld.min=p_s_sld.value * 0.7
        p_s_sld.max=p_s_sld.value * 1.3
        ...
        p_slen.min = 5.0     # 최소 2mm
        p_slen.max = 20.0    # 최대 50mm
